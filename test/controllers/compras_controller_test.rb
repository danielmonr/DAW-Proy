...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { cantidad: @compra.cantidad, id_cliente: @compra.id_cliente, tarjeta: @compra.tarjeta, tipo: @compra.tipo }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { cantidad: @compra.cantidad, id_cliente: @compra.id_cliente, tarjeta: @compra.tarjeta, tipo: @compra.tipo }
    assert_redirected_to compra_path(assigns(:compra))
  end
