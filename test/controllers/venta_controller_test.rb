...
class VentaControllerTest < ActionController::TestCase
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post :create, ventum: { cantidad: @ventum.cantidad, clabe: @ventum.clabe, id_cliente: @ventum.id_cliente }
    end
  ...
  test "should update ventum" do
    patch :update, id: @ventum, ventum: { cantidad: @ventum.cantidad, clabe: @ventum.clabe, id_cliente: @ventum.id_cliente }
    assert_redirected_to ventum_path(assigns(:ventum))
  end
