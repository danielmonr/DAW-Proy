...
class CuentaControllerTest < ActionController::TestCase
  ...
  test "should create cuentum" do
    assert_difference('Cuentum.count') do
      post :create, cuentum: { descripcion: @cuentum.descripcion, id_usuario: @cuentum.id_usuario, saldo: @cuentum.saldo }
    end
  ...
  test "should update cuentum" do
    patch :update, id: @cuentum, cuentum: { descripcion: @cuentum.descripcion, id_usuario: @cuentum.id_usuario, saldo: @cuentum.saldo }
    assert_redirected_to cuentum_path(assigns(:cuentum))
  end
